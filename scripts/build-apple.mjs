...
run('xcodebuild',['-quiet','-jobs','1','-project','apple/Paramount Quality+/Paramount Quality+.xcodeproj','-scheme','Paramount Quality+','-configuration',configuration,'-destination','generic/platform=macOS','-derivedDataPath',output,...(signed ? ['CODE_SIGN_IDENTITY=Apple Development'] : ['CODE_SIGNING_ALLOWED=NO']),'build']);
